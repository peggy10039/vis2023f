...
function _simple1(d3,simple,drag,url_list,invalidation)
{
  ...
  const colorScale = d3.scaleOrdinal(d3.schemeSet3); // 使用 D3 的顏色比例尺
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["simple(分數版)@2.json", {url: new URL("./files/573eeb43992215a62b5ecf324d2f62f25d399beaa2462a07000620a79f3d1955679d952bc6c604b7c8080047fa205a70f9636f8165e333574939aca38aac28a0.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
